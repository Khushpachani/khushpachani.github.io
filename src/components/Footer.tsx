  ...
  return (
    <footer>
      <div className="download-buttons" style={{marginBottom: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px'}}>
        <a 
          href="https://drive.google.com/file/d/1cTbizz8Vqb_L6T-TYtePBn_gDwevfW01/view?usp=sharing" 
          target="_blank"
        ...
        <a 
          href="https://drive.google.com/uc?export=download&id=1cTbizz8Vqb_L6T-TYtePBn_gDwevfW01"
          className="download-btn"
          style={{
            display: 'inline-flex',
            alignItems: 'center',
